...
#include "onnx/optimizer/passes/eliminate_one_input_concat.h"
...
#include "onnx/optimizer/passes/fuse_consecutive_casts.h"
...
struct GlobalPassRegistry {
  ...
  GlobalPassRegistry() {
    ...
    registerPass<EliminateOneInputConcat>();
    ...
    registerPass<FuseConsecutiveCasts>();
